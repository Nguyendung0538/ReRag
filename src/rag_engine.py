...
class LegalRAGEngine:
    ...
    def __init__(self, indexing_strategy: BaseIndexingStrategy, llm_client: LLMClient, old_law_source: str = "", new_law_source: str = ""):
        ...
        self.system_prompt = (
            ...
            "2. PHÂN TÍCH CHI TIẾT CÁC ĐIỂM KHÁC BIỆT: CHỈ liệt kê những nội dung THỰC SỰ CÓ SỰ THAY ĐỔI, THÊM HOẶC BỚT. QUY TẮC CỨNG: BẤT CỨ ĐẠN NÀO HAI BÊN GIỐNG HỆT NHAU THÌ KHÔNG ĐƯỢC PHÉP IN RA Ở PHẦN NÀY DƯỚI BẤT KỲ HÌNH THỨC NÀO.\n"
            "   Trình bày gom nhóm MỖI ĐIỂM KHÁC BIỆT thành 1 gạch đầu dòng lớn:\n"
            "   - **[Chủ đề của điểm khác biệt thứ nhất]** (Ví dụ: Về trách nhiệm hoàn tiền đặt cọc):\n"
            "      + Bản cũ: [Chỉ trích dẫn hoặc tóm tắt CÂU VĂN LIÊN QUAN ở bản cũ]\n"
            "      + Bản mới: [Chỉ trích dẫn CÂU VĂN THAY ĐỔI/THÊM MỚI tương ứng ở bản mới]\n"
            "   - **[Chủ đề của điểm khác biệt thứ hai]** (nếu có):\n"
            "      + Bản cũ: ...\n"
            "      + Bản mới: ...\n\n"
            "3. KẾT LUẬN YẾU TỐ GIỮ NGUYÊN: Nhóm tất cả những đoạn văn bản không hề thay đổi giữa 2 bản thành 1 câu kết luận tường thuật ngắn gọn. "
            "(Ví dụ: \"Các quy định về thời hạn, chấm dứt hợp đồng do sự cố hỏa hoạn và trường hợp Bên B chấm dứt hợp đồng đều được giữ nguyên không đổi.\").\n\n"
            "4. BÁM SÁT DỮ LIỆU: Chỉ sử dụng nội dung từ trích đoạn. Nếu không đủ dữ liệu, báo không đủ.\n"
            "5. BỎ QUA CÁC THAY ĐỔI HÌNH THỨC: Bỏ qua lỗi chính tả, hoặc lỗi khoảng trắng."
        )
